...
class ContrastiveLoss(nn.Module):
    ...
    def text_alignment(self, z1, principal_component=None):
        # text alignment
        text_align = -self.sim(z1, principal_component)

        return text_align.sum(1)
    ...
    def get_loss(self, z1, z2, proj_z1, proj_z2, principal_component):
        ...
        # text_alignment = self.text_alignment(z1, principal_component).mean()
        text_contrast = self.text_contrast(z1, z2, principal_component).mean()

        # return (instance_loss + text_alignment + text_contrast), instance_loss.data.item(), text_alignment.data.item(), text_contrast.data.item()
    ...
    def forward(self, z1, z2, proj_z1, proj_z2, principal_component):
        # l1, ins_loss_1, align_loss_1, contrast_loss_1 = self.get_loss(z1, z2, proj_z1, proj_z2, principal_component)
        # l2, ins_loss_2, align_loss_2, contrast_loss_2 = self.get_loss(z2, z1, proj_z2, proj_z1, principal_component)
        ...
        # align_loss = (align_loss_1 + align_loss_2) * 0.5
        contrast_loss = (contrast_loss_1 + contrast_loss_2) * 0.5
        
        # return ret, ins_loss, align_loss, contrast_loss
